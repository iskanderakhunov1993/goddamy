...
export function CertificatesPage({ navigate }) {
  const certificates = [
    ...
    { title: "Практика Go", progress: "0 из 9 задач", description: "Подтверждает самостоятельное решение задач разных уровней сложности в тренажёре.", action: "Перейти в тренажёр", path: "/go/practice" },
    { title: "SQL для работы", progress: "0 из 6 модулей", description: "Подтверждает умение получать, объединять и анализировать данные с помощью SQL.", action: "Открыть курс", path: "/sql" },
    { title: "Практика SQL", progress: "0 из 9 задач", description: "Серия проверяемых запросов: от SELECT до JOIN, CTE и аналитического отчёта.", action: "Перейти в тренажёр", path: "/sql/practice" },
    { title: "Python для работы", progress: "0 из 6 модулей", description: "Подтверждает владение основами Python, коллекциями, файлами, классами и тестами.", action: "Открыть курс", path: "/python" },
    { title: "Практика Python", progress: "0 из 9 задач", description: "Проверяемые упражнения от строк и списков до файлов и объектной модели.", action: "Перейти в тренажёр", path: "/python/practice" },
