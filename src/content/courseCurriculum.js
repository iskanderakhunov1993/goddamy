...
const lesson = (section, topic, index, title, context) => {
  ...
  return {
    id,
    title,
    summary: context.summary || `Разберём «${title}» и сразу свяжем тему с работой над проектом.`,
    objectives: [
    ...
    blocks: [
      { id: `${id}-brief`, type: "callout", tone: "info", title: "На заметку", text: context.message || "В работе важен не идеальный ответ с первого раза, а понятный следующий шаг и проверяемый результат." },
...
export const courseCurriculum = [
  makeModule("internship-start", "Старт", "ОНБОРДИНГ", "Познакомься с устройством работы в IT и настрой рабочее место.", { message: "Маленькие шаги, честные проверки и вопросы до того, как они станут проблемой." }, [
  ...
  makeModule("go-foundations", "База Go и инженерный подход", "ПОДГОТОВКА", "Освой язык и практики, которые понадобятся в первом проекте.", { message: "Не нужно запоминать весь Go. Нужно научиться находить нужный инструмент, писать маленькие функции и проверять их." }, [
  ...
  makeModule("project-task-tracker", "Проект 1 · Task Tracker CLI", "ПРОЕКТ 1", "Собери консольный трекер задач: от требования до релиза на GitHub.", { message: "Важнее понятный сценарий пользователя и надёжное сохранение данных, чем количество функций." }, [
    ...
    ["task-tests", "Проверка качества", ["Тесты бизнес-логики", "Тесты ошибок", "Проверка CLI вручную", "Саморевью Pull Request", "Итоговый QA-отчёт"]],
  ...
  makeModule("project-expense-tracker", "Проект 2 · Expense Tracker", "ПРОЕКТ 2", "Создай сервис расходов с PostgreSQL, миграциями, API и отчётами.", { message: "Проверяем не только счастливый путь. Деньги, даты и категории должны вести себя предсказуемо в каждой ошибочной ситуации." }, [
  ...
  makeModule("project-url-shortener", "Проект 3 · URL Shortener API", "ПРОЕКТ 3", "Доведи backend-сервис до релиза: API, PostgreSQL, Docker и CI.", { message: "Сервис считается готовым, когда его может запустить другой человек по README. Контейнер и CI — часть продукта, а не украшение после кода." }, [
  ...
  makeModule("graduation", "Релиз, портфолио и завершение стажировки", "ФИНАЛ", "Собери артефакты, пройди финальную проверку и получи сертификат Godemy.", { message: "Ценность разработчика видна в результате: понятный код, проверяемый сервис, прозрачная история изменений и способность объяснить принятые решения." }, [
